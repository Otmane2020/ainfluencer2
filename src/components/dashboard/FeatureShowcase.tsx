...
const features: Feature[] = [
  ...
  },
  {
    id: "ai-video",
    title: "AI Video",
    description: "Sora 2 Pro • Veo 3.1 Pro • Hailuo",
    icon: Film,
  ...
  },
  {
    id: "videos",
    title: "Videos",
    description: "Kling v2.5 • Runway Gen4",
    icon: Video,
  ...
  },
  {
    id: "images",
    title: "Images",
    description: "Flux 2 Pro • Nano Banana • GPT Image",
    icon: Image,
  ...
  },
  {
    id: "product-shots",
    title: "Product Shots",
    description: "Bria • Flux Kontext Pro",
    icon: Camera,
