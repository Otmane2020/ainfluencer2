...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    price: 19,
    priceUnit: "/month",
    description: "For creators exploring AI image & video",
    credits: 60,
    creditValue: CREDIT_UNIT_PRICE,
    features: [
      "60 credits / month",
      "1 credit per image · 4 per video",
      "All Higgsfield image models (Soul, Reve)",
      "Image-to-Video (DoP, Kling, Seedance)",
      "720p & 1080p exports",
  ...
  },
  {
    ...
    price: 49,
    priceUnit: "/month",
    description: "For brands producing content weekly",
    credits: 200,
    creditValue: CREDIT_UNIT_PRICE,
    features: [
      "200 credits / month",
      "1 credit per image · 4 per video",
      "All models — Soul, Reve, DoP, Kling, Seedance",
      "1080p HD exports",
  ...
  },
  {
    ...
    price: 99,
    priceUnit: "/month",
    description: "For agencies and heavy creators",
    credits: 500,
    creditValue: CREDIT_UNIT_PRICE,
    features: [
      "500 credits / month",
      "1 credit per image · 4 per video",
      "All models unlocked (incl. Kling v2.1 Pro)",
      "1080p HD exports",
      "Fastest queue priority",
      "Commercial + team usage rights",
      "API access",
      "Dedicated support",
    ],
    limits: {
...
export const CREDIT_PACKS: CreditPack[] = [
  { id: "pack-5", credits: 5, price: 5, bonus: 0, label: "5 Credits" },
  { id: "pack-20", credits: 20, price: 20, bonus: 0, label: "20 Credits" },
  { id: "pack-50", credits: 50, price: 50, bonus: 0, label: "50 Credits" },
  { id: "pack-100", credits: 100, price: 100, bonus: 0, label: "100 Credits" },
];
