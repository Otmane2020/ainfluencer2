...
const CREDIT_PACK_PRICES: Record<string, { priceId: string; credits: number }> = {
  "pack-5": { priceId: "price_1TTtsiEfti9t9nN9G51T8TIS", credits: 5 },
  "pack-20": { priceId: "price_1TTtsjEfti9t9nN9VhqJ2S7v", credits: 20 },
  "pack-50": { priceId: "price_1TTtskEfti9t9nN9furDfh1K", credits: 50 },
  "pack-100": { priceId: "price_1TTtslEfti9t9nN9uFXKcXrx", credits: 100 },
};
